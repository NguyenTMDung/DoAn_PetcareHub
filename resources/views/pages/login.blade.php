...
<html lang="en">
    <head>
        ...
        <link
            rel="stylesheet"
            href="library/font-awesome/fontawesome-free-6.5.2-web/css/all.css"
        />
            ...
            <ul class="nav al-center ju-center" style="flex-grow: 3">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" style="width: 200px">
                        <li>
                            <a class="dropdown-item" href="#">Dịch vụ Spa</a>
                        </li>
                        <li>
                ...
                <li>
                    <a href="#account" id="account"
                        ><i
                            ...
                            style="color: #003459; padding: 2vw"
                        ></i
                    ></a>
                    <a href="#cart" id="cart"
                        ><i
                            class="class = bi bi-cart4 fa-2x"
                            style="color: #003459"
                        ></i
                    ></a>
                </li>
